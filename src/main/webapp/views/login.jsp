<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        ...
        <head>
            ...
            <link
                href="https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:ital,wght@0,400;0,700;0,900&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap"
                rel="stylesheet">
        ...
        <body class="bg-white overflow-hidden font-sans min-h-screen">
            ...
            <div class="min-h-screen flex">
                ...
                <div class="hidden lg:flex lg:w-5/12 relative overflow-hidden">
                    ...
                    <div class="relative z-10 p-16 flex flex-col justify-end h-full">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <span
                                class="text-3xl font-black text-white italic tracking-tighter uppercase">GreenLife</span>
                        </div>
                        ...
                        <p class="text-emerald-50/80 text-lg font-medium max-w-md leading-relaxed mb-12">
                            Tham gia cộng đồng sống xanh — đặt mục tiêu, theo dõi tiến độ và tạo nên sự thay đổi tích
                            cực cho hành tinh.
                        </p>
                    </div>
                </div>
                ...
                <!-- Right Side - Form -->
                <div
                    class="w-full lg:w-7/12 flex flex-col items-center justify-center p-8 lg:p-24 overflow-x-hidden overflow-y-auto bg-gray-50/30 relative">
                    <div class="w-full max-w-lg relative min-h-[500px]">

                        <!-- ===================== LOGIN FORM ===================== -->
                        <div id="loginFormContainer"
                            class="space-y-10 transition-all duration-500 transform opacity-100 translate-x-0 absolute top-0 left-0 w-full">
                            <div class="text-center md:text-left">
                                <h1 class="text-4xl font-black text-gray-900 mb-3 font-serif">Chào Mừng!</h1>
                                <p class="text-gray-400 font-bold text-sm">Đăng nhập để tiếp tục hành trình xanh của
                                    bạn.</p>
                            </div>

                            <c:if test="${not empty errorMessage}">
                                <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-xl text-[13px] font-bold shadow-sm mb-4"
                                    role="alert">
                                    <p>${errorMessage}</p>
                                </div>
                            </c:if>
                            <c:if test="${not empty successMessage}">
                                <div class="bg-emerald-100 border-l-4 border-emerald-500 text-emerald-700 p-4 rounded-xl text-[13px] font-bold shadow-sm mb-4"
                                    role="alert">
                                    <p>${successMessage}</p>
                                </div>
                            </c:if>
                            ...
                            <form action="${pageContext.request.contextPath}/login" method="post" class="space-y-6">
                                <div class="space-y-2">
                                    <label
                                        class="text-[11px] font-black uppercase text-gray-400 tracking-widest ml-1">Email
                                        / Tên đăng nhập</label>
                                ...
                                <div class="space-y-2">
                                    <label
                                        class="text-[11px] font-black uppercase text-gray-400 tracking-widest ml-1">Mật
                                        Khẩu</label>
                                    <div class="relative group">
                                        <div class="absolute left-5 top-1/2 -translate-y-1/2 text-gray-300">
                                ...
                                <div class="text-center mt-6">
                                    <p class="text-sm font-medium text-gray-500">Chưa có tài khoản? <button
                                            type="button" onclick="toggleForms()"
                                            class="text-emerald-500 hover:text-emerald-600 font-bold ml-1 hover:underline transition-all">Đăng
                                            ký ngay</button></p>
                                </div>
                            </form>
                        </div>
                        ...
                        <div id="registerFormContainer"
                            class="space-y-8 transition-all duration-500 transform opacity-0 translate-x-12 absolute top-0 left-0 w-full pointer-events-none">
                            <div class="text-center md:text-left">
                                <h1 class="text-4xl font-black text-gray-900 mb-3 font-serif">Đăng Ký</h1>
                                <p class="text-gray-400 font-bold text-sm">Gia nhập cộng đồng sống xanh.</p>
                            </div>
                            ...
                            <form action="${pageContext.request.contextPath}/register" method="post" class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1.5">
                                        <label
                                            class="text-[10px] font-black uppercase text-gray-400 tracking-widest ml-1">Tên
                                            đăng nhập</label>
                                        <input type="text" name="username" placeholder="VD: myha" required
                                    ...
                                    <div class="space-y-1.5">
                                        <label
                                            class="text-[10px] font-black uppercase text-gray-400 tracking-widest ml-1">Email</label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-1.5">
                                        <label
                                            class="text-[10px] font-black uppercase text-gray-400 tracking-widest ml-1">Nghề
                                            nghiệp</label>
                                        <input type="text" name="job" placeholder="VD: Giáo viên" required
                                            value="${param.job}"
                                            class="w-full bg-white border-2 border-gray-100 rounded-xl py-3 px-4 text-sm font-medium focus:border-emerald-500/30 focus:ring-4 focus:ring-emerald-500/5 transition-all shadow-sm outline-none" />
                                    </div>
                                    <div class="space-y-1.5">
                                        <label
                                            class="text-[10px] font-black uppercase text-gray-400 tracking-widest ml-1">Địa
                                            chỉ</label>
                                        <input type="text" name="location" placeholder="VD: Đà Nẵng" required
                                ...
                                <div class="space-y-1.5">
                                    <label
                                        class="text-[10px] font-black uppercase text-gray-400 tracking-widest ml-1">Mật
                                        khẩu</label>
                                ...
                                <div class="text-center mt-6">
                                    <p class="text-sm font-medium text-gray-500">Đã có tài khoản? <button type="button"
                                            onclick="toggleForms()"
                                            class="text-[#1B4332] hover:text-[#2D6A4F] font-bold ml-1 hover:underline transition-all">Đăng
                                            nhập</button></p>
                                </div>
                            </form>
                        </div>
            ...
            <script>
                ...
                // Auto toggling if redirected from registration error or via parameter
